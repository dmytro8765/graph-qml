...
#python3.10 job.py -l 30 -q 8 -n 29060424 -c "Cn_circuit" -t "Connectedness" -b "/Users/danielles/Documents/Projekte/BAIQO/invariant_circuits/Pennylane_ML/Graph_ML/data/graph_connectedness" -d "nodes_8-graphs_3000.pt" -e 10 -s 1 -r 0 2>&1 | tee /Users/danielles/Documents/Projekte/BAIQO/invariant_circuits/Pennylane_ML/Graph_ML/output/console_log_ex_2.txt
python3.10 job.py -l 2 -q 8 -n 02071659 -c "Cn_circuit" -t "Connectedness" -b "/Users/danielles/Documents/Projekte/BAIQO/invariant_circuits/Pennylane_ML/Graph_ML/data/graph_connectedness" -d "nodes_8-graphs_3000.pt" -e 2 -s 1 -r 0 2>&1 | tee /Users/danielles/Documents/Projekte/BAIQO/invariant_circuits/Pennylane_ML/Graph_ML/output/console_log_test_pennylane_1.txt
