...
# python3 job_subgraph.py -l 3 -q 6 -sub 4 -n 0 -c "0" -f "y" -b "/Users/home/Quantum_Computing/Pennylane/Graph_ML/data/subgraph" -d "graph-6_subgraph-4_per_qubit_3000_isomorph.pt" -e 30 -s 2

# Parameters: 4 x layers
# python3 job_subgraph.py -l 4 -q 6 -sub 4 -n 0 -c "1" -f "y" -b "/Users/home/Quantum_Computing/Pennylane/Graph_ML/data/subgraph" -d "graph-6_subgraph-4_per_qubit_3000_isomorph.pt" -e 20 -s 2
...
python3 job_subgraph.py -l 30 -q 6 -sub 4 -n 0 -c "7" -f "y" -b "/Users/home/Quantum_Computing/Pennylane/Graph_ML/data/subgraph" -dtrain "graph-6_subgraph-4_3000_iso_train.pt" -dtest "graph-6_subgraph-4_3000_iso_test.pt" -e 25 -s 2

# Parameters: 3 x layers
#python3 job_subgraph.py -l 30 -q 6 -sub 4 -n 0 -c "8" -f "y" -b "/Users/home/Quantum_Computing/Pennylane/Graph_ML/data/subgraph" -dtrain "graph-6_subgraph-4_3000_iso_train.pt" -dtest "graph-6_subgraph-4_3000_iso_test.pt" -e 25 -s 2

# Parameters: 3 x layers + 1
#python3 job_subgraph.py -l 30 -q 6 -sub 4 -n 0 -c "9" -f "y" -b "/Users/home/Quantum_Computing/Pennylane/Graph_ML/data/subgraph" -dtrain "graph-6_subgraph-4_3000_iso_train.pt" -dtest "graph-6_subgraph-4_3000_iso_test.pt" -e 25 -s 2

# Process the results:
python3 log_summary_wandb.py -q 6 -c 7 -n 0 -f "y" -e 25 -s 2 -i 2900 -pt 90