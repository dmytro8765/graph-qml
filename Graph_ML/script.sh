...
python3.10 job.py -l 30 -q 8 -n 29060424 -c "Cn_circuit" -t "Connectedness" -b "/Users/danielle/BAIQO/Pennylane_ML/Graph_ML/data/graph_connectedness" -d "nodes_8-graphs_3000.pt" -e 10 -s 1 -r 0 2>&1 | tee /Users/danielle/BAIQO/Pennylane_ML/Graph_ML/output/console_log_ex_3.txt
