...
python3.10 just_test.py -l 30 -q 8 -n 07251501 -c "Cn_circuit" -t "Connectedness" -b "/home/schuman/Pennylane_ML" -d "nodes_8-graphs_3000.pt" -e 50 -s 10 -sn 0 -w "GC-Cn_circuit-8-90-sampling_10-epochs_50-weights-7251122_s_0" 2>&1 | tee /home/schuman/Pennylane_ML/Graph_ML/output/test_ibm_kingston_with_pennylane_model.txt
